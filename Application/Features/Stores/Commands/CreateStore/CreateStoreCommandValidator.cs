...
{
    public class CreateStoreCommandValidator : AbstractValidator<CreateProductCommand>
    {
        private readonly IProductRepositoryAsync productRepository;

        public CreateStoreCommandValidator(IProductRepositoryAsync productRepository)
        {
